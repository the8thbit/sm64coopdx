...
static struct LuaObjectField sAnimationFields[LUA_ANIMATION_FIELD_COUNT] = {
    { "animYTransDivisor", LVT_S16,   offsetof(struct Animation, animYTransDivisor), true, LOT_NONE    },
    { "flags",             LVT_S16,   offsetof(struct Animation, flags),             true, LOT_NONE    },
    { "index",             LVT_U16_P, offsetof(struct Animation, index),             true, LOT_POINTER },
    { "indexLength",       LVT_U32,   offsetof(struct Animation, indexLength),       true, LOT_NONE    },
    { "length",            LVT_U32,   offsetof(struct Animation, length),            true, LOT_NONE    },
    { "loopEnd",           LVT_S16,   offsetof(struct Animation, loopEnd),           true, LOT_NONE    },
    { "loopStart",         LVT_S16,   offsetof(struct Animation, loopStart),         true, LOT_NONE    },
    { "startFrame",        LVT_S16,   offsetof(struct Animation, startFrame),        true, LOT_NONE    },
    { "values",            LVT_U16_P, offsetof(struct Animation, values),            true, LOT_POINTER },
...
static struct LuaObjectField sAreaFields[LUA_AREA_FIELD_COUNT] = {
    ...
    { "root",                LVT_COBJECT_P, offsetof(struct Area, root),                false, LOT_GRAPHNODEROOT                              },
...
static struct LuaObjectField sBehaviorValuesFields[LUA_BEHAVIOR_VALUES_FIELD_COUNT] = {
    ...
    { "ProcessLODs",              LVT_U8,      offsetof(struct BehaviorValues, ProcessLODs),              false, LOT_NONE                 },
...
static struct LuaObjectField sCharacterFields[LUA_CHARACTER_FIELD_COUNT] = {
    ...
    { "anims",                              LVT_S32,       offsetof(struct Character, anims),                              true, LOT_NONE,      CHAR_ANIM_MAX,  sizeof(s32), true },
    { "cameraHudHead",                      LVT_U32,       offsetof(struct Character, cameraHudHead),                      true, LOT_NONE                                         },
    { "capEnemyDecalGfx",                   LVT_COBJECT_P, offsetof(struct Character, capEnemyDecalGfx),                   true, LOT_GFX                                          },
    { "capEnemyGfx",                        LVT_COBJECT_P, offsetof(struct Character, capEnemyGfx),                        true, LOT_GFX                                          },
    ...
    { "sounds",                             LVT_S32,       offsetof(struct Character, sounds),                             true, LOT_NONE,      CHAR_SOUND_MAX, sizeof(s32), true },
...
static struct LuaObjectField sDialogEntryFields[LUA_DIALOG_ENTRY_FIELD_COUNT] = {
    { "leftOffset",  LVT_S16,      offsetof(struct DialogEntry, leftOffset),  true, LOT_NONE },
    { "linesPerBox", LVT_S8,       offsetof(struct DialogEntry, linesPerBox), true, LOT_NONE },
    { "replaced",    LVT_BOOL,     offsetof(struct DialogEntry, replaced),    true, LOT_NONE },
    { "text",        LVT_STRING_P, offsetof(struct DialogEntry, text),        true, LOT_NONE },
    { "unused",      LVT_U32,      offsetof(struct DialogEntry, unused),      true, LOT_NONE },
...
static struct LuaObjectField sGfxFields[LUA_GFX_FIELD_COUNT] = {
    { "w0", LVT_U64, offsetof(Gwords, w0), true, LOT_NONE },
    { "w1", LVT_U64, offsetof(Gwords, w1), true, LOT_NONE },
};
...
static struct LuaObjectField sGraphNodeAnimatedPartFields[LUA_GRAPH_NODE_ANIMATED_PART_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeAnimatedPart, displayList), false, LOT_GFX       },
...
#define LUA_GRAPH_NODE_BACKGROUND_FIELD_COUNT 5
...
static struct LuaObjectField sGraphNodeBillboardFields[LUA_GRAPH_NODE_BILLBOARD_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeBillboard, displayList), false, LOT_GFX       },
...
static struct LuaObjectField sGraphNodeBoneFields[LUA_GRAPH_NODE_BONE_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeBone, displayList), false, LOT_GFX       },
    { "node",        LVT_COBJECT,   offsetof(struct GraphNodeBone, node),        true,  LOT_GRAPHNODE },
    { "rotation",    LVT_COBJECT,   offsetof(struct GraphNodeBone, rotation),    true,  LOT_VEC3S     },
    { "scale",       LVT_COBJECT,   offsetof(struct GraphNodeBone, scale),       true,  LOT_VEC3F     },
    { "translation", LVT_COBJECT,   offsetof(struct GraphNodeBone, translation), true,  LOT_VEC3S     },
};
...
static struct LuaObjectField sGraphNodeDisplayListFields[LUA_GRAPH_NODE_DISPLAY_LIST_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeDisplayList, displayList), false, LOT_GFX       },
...
static struct LuaObjectField sGraphNodeRootFields[LUA_GRAPH_NODE_ROOT_FIELD_COUNT] = {
    { "areaIndex", LVT_U8,      offsetof(struct GraphNodeRoot, areaIndex), true,  LOT_NONE      },
    { "height",    LVT_S16,     offsetof(struct GraphNodeRoot, height),    false, LOT_NONE      },
    { "node",      LVT_COBJECT, offsetof(struct GraphNodeRoot, node),      true,  LOT_GRAPHNODE },
    { "numViews",  LVT_S16,     offsetof(struct GraphNodeRoot, numViews),  true,  LOT_NONE      },
    { "width",     LVT_S16,     offsetof(struct GraphNodeRoot, width),     false, LOT_NONE      },
    { "x",         LVT_S16,     offsetof(struct GraphNodeRoot, x),         false, LOT_NONE      },
    { "y",         LVT_S16,     offsetof(struct GraphNodeRoot, y),         false, LOT_NONE      },
};
...
static struct LuaObjectField sGraphNodeRotationFields[LUA_GRAPH_NODE_ROTATION_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeRotation, displayList), false, LOT_GFX       },
...
static struct LuaObjectField sGraphNodeScaleFields[LUA_GRAPH_NODE_SCALE_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeScale, displayList), false, LOT_GFX       },
...
static struct LuaObjectField sGraphNodeScaleXYZFields[LUA_GRAPH_NODE_SCALE_XYZ_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeScaleXYZ, displayList), false, LOT_GFX       },
    { "node",        LVT_COBJECT,   offsetof(struct GraphNodeScaleXYZ, node),        true,  LOT_GRAPHNODE },
    { "scale",       LVT_COBJECT,   offsetof(struct GraphNodeScaleXYZ, scale),       true,  LOT_VEC3F     },
};
...
#define LUA_GRAPH_NODE_SWITCH_CASE_FIELD_COUNT 3
static struct LuaObjectField sGraphNodeSwitchCaseFields[LUA_GRAPH_NODE_SWITCH_CASE_FIELD_COUNT] = {
    ...
    { "parameter",    LVT_S16,     offsetof(struct GraphNodeSwitchCase, parameter),    false, LOT_NONE        },
...
static struct LuaObjectField sGraphNodeTranslationFields[LUA_GRAPH_NODE_TRANSLATION_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeTranslation, displayList), false, LOT_GFX       },
...
static struct LuaObjectField sGraphNodeTranslationRotationFields[LUA_GRAPH_NODE_TRANSLATION_ROTATION_FIELD_COUNT] = {
    { "displayList", LVT_COBJECT_P, offsetof(struct GraphNodeTranslationRotation, displayList), false, LOT_GFX       },
...
static struct LuaObjectField sLevelValuesFields[LUA_LEVEL_VALUES_FIELD_COUNT] = {
    ...
    { "fixInvalidShellRides",             LVT_U8,      offsetof(struct LevelValues, fixInvalidShellRides),             false, LOT_NONE          },
    ...
    { "floorNormalMinY",                  LVT_F32,     offsetof(struct LevelValues, floorNormalMinY),                  false, LOT_NONE          },
    ...
    { "wallMaxRadius",                    LVT_F32,     offsetof(struct LevelValues, wallMaxRadius),                    false, LOT_NONE          },
...
static struct LuaObjectField sMarioBodyStateFields[LUA_MARIO_BODY_STATE_FIELD_COUNT] = {
    ...
    { "animPartsMtx",        LVT_COBJECT, offsetof(struct MarioBodyState, animPartsMtx),        true,  LOT_MAT4,  MARIO_ANIM_PART_MAX, sizeof(Mat4),  true },
    { "animPartsPos",        LVT_COBJECT, offsetof(struct MarioBodyState, animPartsPos),        true,  LOT_VEC3F, MARIO_ANIM_PART_MAX, sizeof(Vec3f), true },
    { "animPartsRot",        LVT_COBJECT, offsetof(struct MarioBodyState, animPartsRot),        true,  LOT_VEC3S, MARIO_ANIM_PART_MAX, sizeof(Vec3s), true },
    { "capState",            LVT_S8,      offsetof(struct MarioBodyState, capState),            false, LOT_NONE                                            },
    { "currAnimPart",        LVT_U32,     offsetof(struct MarioBodyState, currAnimPart),        true,  LOT_NONE                                            },
    ...
    { "updateHeadPosTime",   LVT_U32,     offsetof(struct MarioBodyState, updateHeadPosTime),   true,  LOT_NONE                                            },
...
static struct LuaObjectField sMarioStateFields[LUA_MARIO_STATE_FIELD_COUNT] = {
    ...
    { "dialogId",                  LVT_S32,       offsetof(struct MarioState, dialogId),                  true,  LOT_NONE              },
...
static struct LuaObjectField sModFields[LUA_MOD_FIELD_COUNT] = {
    ...
    { "favorited",            LVT_BOOL,     offsetof(struct Mod, favorited),            true, LOT_NONE },
    ...
    { "hasModMenu",           LVT_BOOL,     offsetof(struct Mod, hasModMenu),           true, LOT_NONE },
...
#define LUA_MOD_AUDIO_FIELD_COUNT 19
static struct LuaObjectField sModAudioFields[LUA_MOD_AUDIO_FIELD_COUNT] = {
    ...
    { "copy",         LVT_FUNCTION, .function = "audio_copy"                                },
    ...
    { "frequency",    LVT_PROPERTY, .get = "audio_get_frequency",            .set = "audio_set_frequency" },
    { "length",       LVT_PROPERTY, .get = "audio_get_length"                               },
    ...
    { "reload",       LVT_FUNCTION, .function = "audio_reload"                              },
    { "sampleRate",   LVT_PROPERTY, .get = "audio_get_sample_rate"                          },
    { "stop",         LVT_FUNCTION, .function = "audio_stop"                                },
    { "volume",       LVT_PROPERTY, .get = "audio_get_volume",               .set = "audio_set_volume" },
};
...
static struct LuaObjectField sModFsFields[LUA_MOD_FS_FIELD_COUNT] = {
    ...
    { "isPublic",     LVT_BOOL,      offsetof(struct ModFs, isPublic),  true, LOT_NONE },
    { "mod",          LVT_COBJECT_P, offsetof(struct ModFs, mod),       true, LOT_MOD  },
    { "modPath",      LVT_STRING,    offsetof(struct ModFs, modPath),   true, LOT_NONE },
    { "move_file",    LVT_FUNCTION,  .function = "mod_fs_move_file"                    },
    { "numFiles",     LVT_U16,       offsetof(struct ModFs, numFiles),  true, LOT_NONE },
    { "save",         LVT_FUNCTION,  .function = "mod_fs_save"                         },
    { "set_public",   LVT_FUNCTION,  .function = "mod_fs_set_public"                   },
    { "totalSize",    LVT_U32,       offsetof(struct ModFs, totalSize), true, LOT_NONE },
};

#define LUA_MOD_FS_FILE_FIELD_COUNT 27
static struct LuaObjectField sModFsFileFields[LUA_MOD_FS_FILE_FIELD_COUNT] = {
    { "compressionLevel", LVT_S32,       offsetof(struct ModFsFile, compressionLevel), true, LOT_NONE  },
    { "erase",            LVT_FUNCTION,  .function = "mod_fs_file_erase"                               },
    { "filepath",         LVT_STRING,    offsetof(struct ModFsFile, filepath),         true, LOT_NONE  },
    { "fill",             LVT_FUNCTION,  .function = "mod_fs_file_fill"                                },
    { "isPublic",         LVT_BOOL,      offsetof(struct ModFsFile, isPublic),         true, LOT_NONE  },
    { "isText",           LVT_BOOL,      offsetof(struct ModFsFile, isText),           true, LOT_NONE  },
    { "is_eof",           LVT_FUNCTION,  .function = "mod_fs_file_is_eof"                              },
    { "modFs",            LVT_COBJECT_P, offsetof(struct ModFsFile, modFs),            true, LOT_MODFS },
    { "offset",           LVT_U32,       offsetof(struct ModFsFile, offset),           true, LOT_NONE  },
    ...
    { "set_compression",  LVT_FUNCTION,  .function = "mod_fs_file_set_compression"                     },
    { "set_public",       LVT_FUNCTION,  .function = "mod_fs_file_set_public"                          },
    { "set_text_mode",    LVT_FUNCTION,  .function = "mod_fs_file_set_text_mode"                       },
    { "size",             LVT_U32,       offsetof(struct ModFsFile, size),             true, LOT_NONE  },
...
//  { "oHiddenStarLastInteractedObject",            LVT_???,                 offsetof(struct Object, oHiddenStarLastInteractedObject),            false, LOT_???                                   }, <--- UNIMPLEMENTED
    ...
    { "oLightID",                                   LVT_S32,                 offsetof(struct Object, oLightID),                                   false, LOT_NONE                                  },
    ...
    { "oMarioJumboStarCutscenePosZ",                LVT_F32,                 offsetof(struct Object, oMarioJumboStarCutscenePosZ),                false, LOT_NONE                                  },
...
//  { "oStarBehavior",                              LVT_???,                 offsetof(struct Object, oStarBehavior),                              true,  LOT_???                                   }, <--- UNIMPLEMENTED
    ...
    { "oToadMessageDialogId",                       LVT_S32,                 offsetof(struct Object, oToadMessageDialogId),                       false, LOT_NONE                                  },
...
static struct LuaObjectField sPlayerPaletteFields[LUA_PLAYER_PALETTE_FIELD_COUNT] = {
    { "parts", LVT_COBJECT, offsetof(struct PlayerPalette, parts), true, LOT_COLOR, PLAYER_PART_MAX, sizeof(Color), true },
};
...
static struct LuaObjectField sStaticObjectCollisionFields[LUA_STATIC_OBJECT_COLLISION_FIELD_COUNT] = {
    { "index",  LVT_U32, offsetof(struct StaticObjectCollision, index),  true, LOT_NONE },
...
static struct LuaObjectField sVtxFields[LUA_VTX_FIELD_COUNT] = {
    ...
    { "b",    LVT_U8,  offsetof(Vtx_L, b),    false, LOT_NONE },
    { "flag", LVT_U16, offsetof(Vtx_L, flag), false, LOT_NONE },
    { "g",    LVT_U8,  offsetof(Vtx_L, g),    false, LOT_NONE },
    { "nx",   LVT_S8,  offsetof(Vtx_L, nx),   false, LOT_NONE },
    { "ny",   LVT_S8,  offsetof(Vtx_L, ny),   false, LOT_NONE },
    { "nz",   LVT_S8,  offsetof(Vtx_L, nz),   false, LOT_NONE },
    { "r",    LVT_U8,  offsetof(Vtx_L, r),    false, LOT_NONE },
    { "tu",   LVT_S16, offsetof(Vtx_L, tu),   false, LOT_NONE },
    { "tv",   LVT_S16, offsetof(Vtx_L, tv),   false, LOT_NONE },
    { "x",    LVT_F32, offsetof(Vtx_L, x),    false, LOT_NONE },
    { "y",    LVT_F32, offsetof(Vtx_L, y),    false, LOT_NONE },
    { "z",    LVT_F32, offsetof(Vtx_L, z),    false, LOT_NONE },
};
...
static struct LuaObjectField sWaterDropletParamsFields[LUA_WATER_DROPLET_PARAMS_FIELD_COUNT] = {
    ...
    { "model",                LVT_S16,              offsetof(struct WaterDropletParams, model),                true,  LOT_NONE    },
